    ...
    update () {
        ...
        this.panel = new SettingsPanel({
            ...
            note: `<div class="text icon icon-question" id="shared-settings-note" tabindex="-1">` +
                  `These are Atom's shared settings which affect behavior unrelated to text editing. ` +
                  `Individual packages may have their own additional settings found within their ` +
                  `package card in the <a class="link packages-open">Packages list</a>.</div>`
        })
